                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-level"  value="<?php  echo $this->set_field_value('level',""); ?>" type="number" placeholder="Enter Level" step="1"  required="" name="level"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="no_petugas">No Petugas <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-no_petugas"  value="<?php  echo $this->set_field_value('no_petugas',""); ?>" type="number" placeholder="Enter No Petugas" step="1"  required="" name="no_petugas"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
